...
create user  app_logger_elmah  identified by L3tM3sEE  default tablespace  USERS  temporary tablespace temp;
grant CDM_READER_PUBLIC to app_logger_elmah ;
grant developer_role to app_logger_elmah ;

alter session  set current_schema = app_logger_elmah ;
